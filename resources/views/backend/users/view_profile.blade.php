                ...
                <div class="content content-full text-center">
                    ...
                    <div class="mb-15">
                        <a class="img-link" href="be_pages_generic_profile.html">
                            <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{ Auth::user()->profile_photo_url }}
                                    alt="">
                            </a>
                        </div>
                        <!-- END Avatar -->
                        ...
                        <!-- Personal -->
                        <h1 class=" h3 text-white font-w700 mb-10">{{ Auth::user()->first_name }}
                    ...
                    <div class="block-content">
                        <form action="be_pages_generic_profile.edit.html" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row items-push">
                                <div class="col-lg-3">
                                    <p class="text-muted">
                                        Hi, {{ Auth::user()->first_name }}. Your account’s vital info. Your username will
                                        be publicly visible.
                                    </p>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                ...
                                                placeholder="Enter your username.." value="john.doe">
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-10 col-xl-6">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input" id="profile-settings-avatar"
                                                    name="profile-settings-avatar" data-toggle="custom-file-input">
