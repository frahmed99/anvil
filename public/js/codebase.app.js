  ...
  _createClass(Helpers, null, [{
    ...
    function run(helpers) {
      ...
      var helperList = {
        ...
        // Codebase
        'cb-toggle-class': function cbToggleClass() {
          return _this.cbToggleClass();
        },
        'cb-year-copy': function cbYearCopy() {
          return _this.cbYearCopy();
        },
        'cb-ripple': function cbRipple() {
          return _this.cbRipple();
        },
        'cb-print': function cbPrint() {
          return _this.cbPrint();
        },
        'cb-table-tools-sections': function cbTableToolsSections() {
          return _this.cbTableToolsSections();
        },
        'cb-table-tools-checkable': function cbTableToolsCheckable() {
          return _this.cbTableToolsCheckable();
        },
        // JavaScript
    ...
    key: "cbTableToolsSections",
    value: function cbTableToolsSections() {
    ...
    key: "cbTableToolsCheckable",
    value: function cbTableToolsCheckable() {
      var _this2 = this;
...
var Template = /*#__PURE__*/function () {
  ...
  _createClass(Template, [{
    ...
    value: function _uiInit() {
      ...
      this.helpers(['bs-tooltip', 'bs-popover', 'cb-toggle-class', 'cb-year-copy', 'cb-ripple']); // Page Loader (hide it)
    ...
    value: function _uiHandleDarkMode() {
      ...
      if (self._lPage.classList.contains('remember-theme')) {
        var darkMode = localStorage.getItem('codebaseDarkMode') || false;
    ...
    value: function _uiHandleTheme() {
      ...
      if (rememberTheme) {
        var themeName = localStorage.getItem('codebaseThemeName') || false; // Update color theme
    ...
    value: function _uiApiLayout() {
      ...
      var layoutAPI = {
        ...
        header_modern_toggle: function header_modern_toggle() {
        ...
        header_modern_on: function header_modern_on() {
          self._lPage.classList.add('page-header-modern');

          self._lPage.classList.remove('page-header-glass');
        },
        header_modern_off: function header_modern_off() {
          self._lPage.classList.remove('page-header-modern');
        },
...
/* harmony export */ });
/* harmony import */ var _modules_template__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/template */ "./resources/js/codebase/modules/template.js");
